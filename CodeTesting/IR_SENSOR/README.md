...
# here is a product detail of the board https://www.hotmcu.com/ir-reflective-sensor-tcrt5000-p-184.html
# it has the sensor datasheet here -> https://www.vishay.com/docs/83760/tcrt5000.pdf
...
### main code
# loop uses the timing code to measure how fast of a reading occurs can be tested

### IR.c IR.h
# contain functions for use of IR sensor.
